...
function Stamp({ children, color = 'indigo' }) {
    const colorMap = {
...
function Hero() {
    return (
        <section className="min-h-[90dvh] flex flex-col items-center justify-center text-center px-6 pt-32 pb-16 relative overflow-hidden">
            {/* Animated Background Blobs */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                <div className="shimmer absolute top-[10%] left-[15%] w-[40vw] h-[40vw] rounded-full mix-blend-multiply blur-[80px]" style={{ background: 'radial-gradient(circle, rgba(79,70,229,0.15) 0%, transparent 70%)' }} />
                <div className="shimmer anim-delay-2 absolute bottom-[10%] right-[15%] w-[35vw] h-[35vw] rounded-full mix-blend-multiply blur-[80px]" style={{ background: 'radial-gradient(circle, rgba(5,150,105,0.15) 0%, transparent 70%)' }} />
            </div>

            {/* Badge */}
            <div className="anim-up mb-6 relative z-10">
                <Stamp color="emerald">❖ A* Edexcel Graduate · IGCSE Specialist</Stamp>
            </div>

            {/* Headline */}
            <h1 className="anim-up text-5xl sm:text-6xl md:text-7xl font-extrabold font-serif mb-6 max-w-4xl relative z-10 tracking-tight text-[var(--text)]">
                Master IGCSE{' '}
            ...
            <p className="anim-up anim-delay-1 text-lg sm:text-xl text-[var(--text-muted)] max-w-2xl mb-10 relative z-10 leading-relaxed font-sans">
            ...
            {/* CTAs */}
            <div className="anim-up anim-delay-2 flex flex-wrap gap-4 justify-center mb-16 relative z-10">
            ...
            {/* Stats row */}
            <div className="anim-up anim-delay-3 flex flex-wrap gap-x-12 gap-y-8 justify-center relative z-10">
                {[
